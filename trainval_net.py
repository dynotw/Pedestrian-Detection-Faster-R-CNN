...
def parse_args():
    ...
    parser.add_argument('--save_dir', dest='save_dir',
                        help='directory to save models', default="modelsfull",
                        type=str)
...
if __name__ == '__main__':
    ...
    #看combined_roidb函数作用----调用了get_imdb得到lib/dataset/factory.py生成的imdb
